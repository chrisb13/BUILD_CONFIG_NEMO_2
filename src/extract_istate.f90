...
status = NF90_INQ_VARID(fidTin,"votemper",votemper_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidTin,"toce",votemper_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidTin,"thetao",votemper_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidTin,"temperature",votemper_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidTin,"TEMPERATURE",votemper_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidTin,"TEMP",votemper_ID)
call erreur(status,.TRUE.,"inq_votemper_GLO_ID")
...
status = NF90_INQ_VARID(fidSin,"vosaline",vosaline_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidSin,"soce",vosaline_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidSin,"salinity",vosaline_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidSin,"SALINITY",vosaline_ID)
if ( status .ne. 0 ) status = NF90_INQ_VARID(fidSin,"SALT",vosaline_ID)
call erreur(status,.TRUE.,"inq_vosaline_GLO_ID")
